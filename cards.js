...
(d => {
    ...
    window.addEventListener('resize', function() {
        ...
        if ((!isMobileSize && itemsPerPage !== 6) || (isMobileSize && itemsPerPage !== 4)) {
    ...
    function renderPage() {
        ...
        currentWorks.forEach((work, index) => {
            ...
            $cloneTemplate.querySelector("h6").textContent = work.title;
            ...
            $templateModal.querySelector("h4").textContent = work.title;
